...
# keep only simple predictors: demogrpahics and baseline symptoms
X <- X[, c('age', 'gender_M', 'bdi_1_1_bdi', 'bai_1_1_bai', 'msm', 'cgi_s_1_1_cgi',
           grep('Delta_Coherence', names(X), value = T))]
```
...
model_spec <- logistic_reg(mixture = 1, penalty = 0.1) %>%
  set_engine("glmnet") %>%
